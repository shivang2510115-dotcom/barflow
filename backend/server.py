...
from routers import auth, tables, menu, orders, inventory, reports, payments, guests, rooms
...
for module in (auth, tables, menu, orders, inventory, reports, payments, guests, rooms):
